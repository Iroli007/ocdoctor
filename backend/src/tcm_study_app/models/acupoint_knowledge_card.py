...
class AcupointKnowledgeCard(Base):
    """Structured typed record for meridian/acupoint cards."""

    __tablename__ = "acupoint_knowledge_cards"
    ...
    acupoint_property: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    knowledge_card: Mapped["KnowledgeCard"] = relationship(
        "KnowledgeCard",
        back_populates="acupoint_knowledge_card",
    )
